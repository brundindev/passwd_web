          ...
          <div className="mx-auto grid max-w-sm gap-8 sm:max-w-none sm:grid-cols-2 md:gap-x-10 md:gap-y-12 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                Todas tus contraseñas están protegidas con cifrado de última generación, garantizando que solo tú puedas acceder a ellas.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Accede a tus contraseñas desde cualquier dispositivo, sincronizándolas de forma segura entre todas tus plataformas.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Crea contraseñas fuertes y seguras con nuestro generador integrado, sin tener que preocuparte por recordarlas todas.
              </p>
            </article>
            <article>
              <svg
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
                Autenticación Biométrica <span className="text-red-500 font-semibold border border-red-500 rounded-md px-2 py-1">En desarrollo</span>
              </h3>
              <p className="text-indigo-200/65">
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Rellena formularios y accede a tus sitios web favoritos con un solo clic, ahorrando tiempo y evitando errores de escritura.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Recibe notificaciones sobre posibles brechas de seguridad y contraseñas vulnerables, manteniéndote siempre protegido.
              </p>
            </article>
          </div>
        </div>
